...
<section id="features" class="section">
    <div class="container">
        ...
        <div class="features-list">
            <div class="feature-item"><i class="fas fa-check-circle"></i><span>Real-time hex validation</span></div>
            <div class="feature-item"><i class="fas fa-check-circle"></i><span>Copy results with one click</span></div>
            <div class="feature-item"><i class="fas fa-check-circle"></i><span>Dark and light themes</span></div>
            <div class="feature-item"><i class="fas fa-check-circle"></i><span>Animated user interface</span></div>
            <div class="feature-item"><i class="fas fa-check-circle"></i><span>Installable as mobile app</span></div>
            <div class="feature-item"><i class="fas fa-check-circle"></i><span>Works completely offline</span></div>
        </div>
    </div>
</section>
